  ...
  return (
    <div className="container">
      ...
      <div className="servicescard">
        ...
        <p>
          Our tree and shrub care service includes pruning, disease management,
          and fertilization to keep your trees and shrubs healthy and vibrant.
        </p>
      </div>
      <div className="servicescard">
        <h2>Lawn Care</h2>
      ...
      <div className="servicescard">
        ...
        <p>
          ...
          your landscape receives the right amount of water it needs to thrive.
        </p>
      </div>
      <div className="servicescard">
